-- Fix the execute_bonding_curve_trade function to update holders count
...
BEGIN
  ...
  IF p_trade_type = 'buy' THEN
    ...
    -- Update agent with new prompt raised and holders count
    UPDATE agents 
    SET prompt_raised = v_new_prompt_raised,
        token_holders = v_holders_count
    WHERE id = p_agent_id;
