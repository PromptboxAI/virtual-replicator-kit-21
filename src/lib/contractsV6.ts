...
// V6 contracts - Deployed on 2025-12-28 to Base Sepolia
export const REWARD_DISTRIBUTOR_V6_ADDRESS = '0x073a99D2Fe87039410a248610189E9d02062Df8B';
export const TEAM_VESTING_V6_ADDRESS = '0x3E3BEc9EFA5108FdeD9d6CDdcD321be146756444';
export const LP_LOCKER_V6_ADDRESS = '0x447E38a419400183De1D4Af27Ab3F3F82Aa1DB3b';
export const GRADUATION_MANAGER_V6_ADDRESS = '0x4cB9946f959B0caC5C30c830e706A5D733620Cf7';
export const AGENT_FACTORY_V6_ADDRESS = '0x9852671994E4DD979438145fc0a26e123eCc22Dc';
...
export function isV6Deployed(): boolean {
  return GRADUATION_MANAGER_V6_ADDRESS.length === 42 && !GRADUATION_MANAGER_V6_ADDRESS.startsWith('0x000000');
}
